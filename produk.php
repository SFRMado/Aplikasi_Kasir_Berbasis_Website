...
<!-- isinya -->
    <h1 class="h3 mb-0">
        Data Produk
        <button class="btn btn-primary btn-sm border-0 float-right" type="button" data-toggle="modal" data-target="#TambahProduk">+ Tambah Data Produk</button>
    </h1>
<hr>
...
<?php 
  ...
  <tr>
    ...
    <td>
      Rp.<?php echo ribuan($d['harga_modal']); ?>
  </td>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content border-0">
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
            <label class="samll">Stok Barang :</label>
            <input type="number" placeholder="0" name="Edit_Stok_Barang" value="<?php echo $d['stok_barang']; ?>" class="form-control" required>
        </div>
        <div class="form-group">
...
if(isset($_POST['TambahProduk']))
{
    ...
    $stokbarang = htmlspecialchars($_POST['Tambah_Stok_Barang']);
    ...
    $InputProduk = mysqli_query($conn,"INSERT INTO produk (kode_produk,nama_produk,stok_barang,harga_modal,harga_jual)
     values ('$kodeproduk','$namaproduk','$stokbarang','$harga_modal','$harga_jual')");
    if ($InputProduk){
...
if(isset($_POST['SimpanEdit'])){
    ...
    $stokbarang1 = htmlspecialchars($_POST['Edit_Stok_Barang']);
    ...
    if($HasilData > 0){
        ...
        nama_produk='$namaproduk1',stok_barang='$stokbarang1',harga_modal='$harga_modal1',harga_jual='$harga_jual1'
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content border-0">
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
            <label class="samll">Stok Barang :</label>
            <input type="number" placeholder="0" name="Tambah_Stok_Barang" class="form-control" required>
        </div>
        <div class="form-group">
            <label class="samll">Harga Modal :</label>
